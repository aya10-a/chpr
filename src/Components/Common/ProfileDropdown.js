            ...
            <Dropdown isOpen={isProfileDropdown} toggle={toggleProfileDropdown} className="ms-sm-3 header-item topbar-user">
                ...
                <DropdownMenu className="dropdown-menu-end">
                    ...
                    <DropdownItem href={process.env.PUBLIC_URL + "/pages-profile-settings"}>
                        <i className="mdi mdi-cart text-muted fs-16 align-middle me-1"></i>
                    ...
                    <DropdownItem href={process.env.PUBLIC_URL + "/profile"}><span
                        className="badge bg-soft-success text-success mt-1 float-end"></span><i
                    ...
                    <DropdownItem href={process.env.PUBLIC_URL + "auth-logout-cover"}><i
